...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let block = BlockNode(startsAt: CGFloat(-line.range), endsAt: CGFloat(line.range))
        
        self.addChild(block)
        
        
        //train.position.x = -60
        let followPath = SKAction.follow(line.getPath(for: .inBound), asOffset: true, orientToPath: true, speed: 20)
        /*
